...
{#if event}
	<div class="space-y-6 animate-in">
		...
		<div class="bg-yellow-pale border border-yellow/40 rounded-lg px-4 py-2.5 flex items-start gap-2.5 text-[11px] font-body text-graphite">
			...
			<span>Please verify the date and time of this game against the <a href="https://www.mlb.com/bluejays/schedule" target="_blank" class="underline font-semibold hover:text-jays-blue">official Blue Jays schedule</a> before making plans. Our schedule may contain errors or omissions.</span>
		</div>
